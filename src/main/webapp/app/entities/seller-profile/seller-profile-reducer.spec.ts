...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLERPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELLERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELLERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELLERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELLERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELLERPROFILE actions', async () => {
      const expectedActions = [
        {
