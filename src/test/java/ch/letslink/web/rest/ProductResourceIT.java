...
import static ch.letslink.web.rest.TestUtil.sameNumber;
...
import ch.letslink.service.ProductService;
...
class ProductResourceIT {
    ...
    private static final ProductCategory DEFAULT_PRODUCT_CATEGORY = ProductCategory.BEAT;
    private static final ProductCategory UPDATED_PRODUCT_CATEGORY = ProductCategory.LOOP;
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getFile()).isEqualTo(UPDATED_FILE);
        assertThat(testProduct.getFileContentType()).isEqualTo(UPDATED_FILE_CONTENT_TYPE);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.price(UPDATED_PRICE).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
