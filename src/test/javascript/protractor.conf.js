  ...
  capabilities: {
    ...
    chromeOptions: {
      args: process.env.JHI_E2E_HEADLESS
        ? ['--headless', '--disable-gpu', '--window-size=800,600', '--disable-extensions', '--disable-dev-shm-usage']
        : ['--disable-gpu', '--window-size=800,600', '--disable-extensions', '--disable-dev-shm-usage'],
    },
  },
