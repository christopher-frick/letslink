...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTLINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTLINK actions', async () => {
      const expectedActions = [
        {
