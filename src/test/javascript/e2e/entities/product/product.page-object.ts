...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('letslinkApp.product.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/letslinkApp.product.delete.question/);
